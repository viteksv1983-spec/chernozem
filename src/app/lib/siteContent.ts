...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  hero: {
    badge: "Працюємо з 2015 · Понад 2 000 клієнтів · Київ і область",
    headlineLine1: "Екологічно чистий чорнозем",
    headlineAccent: "з доставкою",
    headlineLine2: "по Києву та області",
    subheadline:
      "Без торфу, глини, глею та бур'янів. Розсипчастий, насичений гумусом. Доставка сьогодні або завтра — у зручний для вас час.",
  ...
  faq: [
    {
      ...
      a: "Для доставки насипом — мінімальне замов��ення від 5 тонн (це приблизно один кузов ЗІЛа). Для чорнозему в мішках — від 1 мішка (50 кг, 100 грн). Також доступний самовивіз зі складу за адресою: вул. Перевальна 17, Київ.",
    },
    {
